        ...
        function P(t, r, n) {
          ...
          return function (i, a) {
            ...
            for (n.method = i, n.arg = a; ; ) {
              ...
              var u = l(t, r, n)
              if ('normal' === u.type) {
                if (((o = n.done ? d : p), u.arg === y)) continue
        ...
        function o(e, r) {
          ...
          return (
            ...
            (n.ln = function (t) {
              ...
              !i && n.mn && (a.isUpdate = !0),
                n.dispatchEvent(new s(o, a)),
                'installed' === o
                  ? (n.wn = self.setTimeout(function () {
                      'installed' === o &&
                        e.waiting === r &&
                        n.dispatchEvent(new s('waiting', a))
                    }, 200))
                  : 'activating' === o &&
                    (clearTimeout(n.wn), i || n.en.resolve(r))
            }),
            (n.dn = function (t) {
              var e = n.hn,
        ...
        (function () {
          ...
          return (
            ...
            (e.dispatchEvent = function (t) {
              t.target = this
              for (var e, r = i(this.Sn(t.type)); !(e = r()).done; )
                (0, e.value)(t)
            }),
            (e.Sn = function (t) {
